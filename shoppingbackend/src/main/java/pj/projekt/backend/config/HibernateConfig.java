package pj.projekt.backend.config;
...
@Configuration
@ComponentScan(basePackages={"pj.projekt.backend.dto"})
@EnableTransactionManagement
public class HibernateConfig {

	// Change the below based on the DBMS you choose
	private final static String DATABASE_URL = "jdbc:mysql://localhost:3306/car_rental"; 
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("pj.projekt.backend.dto");
